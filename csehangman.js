...
var levelOne= ["4353454354467B4369217068337240313233347D"];

// determine gameword
var index = alert("Welcome to Hangman!");        
var levels= [levelOne];
var wordChoices= levels[1 - 1]
...
function showGuessedWord() {
    document.getElementById("idResult").innerHTML = "The word is " + gameWord;
}
...
var hangmanArray = [head, BArms, Legs];
...
function addBodyPart() {
	numberOfMissedGuesses++;
        if (numberOfMissedGuesses === hangmanArray.length-1) {
        	gameOver("lost");
        }
